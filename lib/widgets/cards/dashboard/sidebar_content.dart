import '../../../modules/getX/navigation_controller.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import '/widgets/buttons/sidebar_button.dart';
import '../../../modules/getX/widget_controller.dart';
...
class SidebarContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder(init: WidgetController(), builder:(controller) => controller.isDrawer.value ? Container(
      width: 272,
      height: height,
      ...
      child: ListView(
        children: [
          ...
          GetBuilder(
            ...
            builder: (controller) => SidebarButton(
                context: context,
                ...
                trailingIcon: controller.isActive.value
                    ? Icons.keyboard_arrow_down_rounded
                    : Icons.keyboard_arrow_right_rounded,
                isActiveDropdown: controller.isActive.value,
                onCallback: controller.onUpdateDropdown),
            id: 'manajemen_anggota',
          ),
          const Divider(),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 15, vertical: 10),
          ...
          GetBuilder(
            ...
            builder: (controller) => SidebarButton(
              ...
              subtitle2: [
                {
                  'id': 'Semua Pengaduan',
                  'callback': () {
                    navigationController.navigateTo(RoutePath.allComplaints);
                  }
                },
                {
                  'id': 'Masuk',
              ...
              trailingIcon: controller.isActive.value
                  ...
                  : Icons.keyboard_arrow_right_rounded,
              isActiveDropdown: controller.isActive.value,
              onCallback: controller.onUpdateDropdown2,
            ),
            id: 'daftar_pengaduan',
          ),
          const Divider(),
          ...
          SidebarButton(
              ...
              title: 'Keluar',
              onCallback: () => Navigator.pushNamed(context, RoutePath.login)),
